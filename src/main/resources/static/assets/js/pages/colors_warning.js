...
$(function() {
    ...
    $('.select').select2({
        ...
        dropdownCssClass: 'select2-results-warning'
    });
    ...
    var init = new Switchery(switchery, {color: '#C69817'});
    ...
    colorBorderNavsActive.addClass('nav-tabs-warning');

    var colorActiveDropdown = $('ul.dropdown-menu').addClass('menu-warning');
