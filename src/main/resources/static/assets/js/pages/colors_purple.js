...
$(function() {
    ...
    $('.select').select2({
        ...
        dropdownCssClass: 'select2-results-purple'
    });
    ...
    //$('.nav-tabs.nav-tabs-highlight>li.active>a, .nav-tabs.nav-tabs-highlight>li.active>a:focus, .nav-tabs.nav-tabs-highlight>li.active>a:hover').css('border-top-color', 'yellow');

    var colorBorderNavsActive = $('ul.nav-tabs').removeClass('nav-tabs-highlight');
    colorBorderNavsActive.addClass('nav-tabs-purple');

    var colorActiveDropdown = $('ul.dropdown-menu').addClass('menu-purple');
});
