...
function guardarUrl(){
	...
	if(compruebaUrl()==true){//lanzo ajax 
                	...
                	var namefile=data.fileName;
 					...
 					$('#modal_iconified').modal('hide');
 					 swal({
 			             ...
 			             text: "Pulsa en el boton para descargarlo.Tambi&eacute;n se puede descargar en el siguiente enlace que estar&aacute; activo en las pr&oacute;ximas 3 horas .<a href='/downloadFile/"+namefile+"'>aqu&iacute;</a>",
		...
		swal({
            title: "Oops...",
            text: "Por favor introduzca las url's para poder continuar o cancele el proceso sino quiere continuar con la conversi&oacute;n del documento!",
            confirmButtonColor: "#EF5350",
            type: "error"
        });
	}
					    			                ...
					    			                success: function (data)
					    			                {
					    			                	var namefile=data.fileName;
					    			 					...
					    			 					$('#modal_iconified').modal('hide');
					    			 					 swal({
					    			 			             title: "Fichero Procesado correctamente!",
					    			 			             text: "Pulsa en el bot&oacute;n para descargar.<a href='/downloadFile/"+namefile+"'>aqu&iacute;</a>",
					    			 			             confirmButtonColor: "#66BB6A",
					    			 			             confirmButtonText: 'Descargar',
					    			 			             html: true,
					    			 			             type: "success"
