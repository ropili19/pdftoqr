...
$(function() {
    ...
    $('.select').select2({
        ...
        dropdownCssClass: 'select2-results-danger'
    });
    ...
    var init = new Switchery(switchery, {color: '#F4511E'});
    ...
    colorBorderNavsActive.addClass('nav-tabs-danger');

    var colorActiveDropdown = $('ul.dropdown-menu').addClass('menu-danger');
